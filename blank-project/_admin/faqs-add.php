            ...
            <div class="row">
                ...
                <div class="col-11">
                    <div id="content-area">
                        ...
                        <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>faqs-remote<?php echo PHP_EXTENSION; ?>/add/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="<?php echo $form_target;?>">
