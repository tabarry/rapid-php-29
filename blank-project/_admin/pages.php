...
//Get records from database
                                            ...
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE) || ($duplicateAccess == TRUE) || ($restoreAccess == TRUE)) { ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if ($deleteAccess == TRUE) { ?>
                                                        <a title="<?php echo DELETE; ?>" id="card_<?php echo $row['page__ID']; ?>_del" onclick="return delById('card_<?php echo $row['page__ID']; ?>', '<?php echo CONFIRM_DELETE_RESTORE; ?>')" href="<?php echo ADMIN_URL; ?>pages-remote<?php echo PHP_EXTENSION; ?>/delete/<?php echo $row['page__ID']; ?>/" target="<?php echo $form_target;?>"><i class="fa fa-times color-Crimson"></i></a>
                                                    <?php } ?>

                                                    <!-- RESTORE -->
                                                    <?php if ($restoreAccess == TRUE) { ?>
                                                        <a title="<?php echo RESTORE; ?>" id="card_<?php echo $row['page__ID']; ?>_restore" href="<?php echo ADMIN_URL; ?>pages-remote<?php echo PHP_EXTENSION; ?>/restore/<?php echo $row['page__ID']; ?>/" target="<?php echo $form_target;?>" style="display:none"><i class="fa fa-undo"></i></a>
                                                    <?php } ?>
                            ...
                            <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                <p class="text-right mb-2"><a target="<?php echo $form_target;?>" href="<?php echo ADMIN_URL; ?>pages<?php echo PHP_EXTENSION; ?>/stream-csv/" class="btn btn-dark"><i class="fa fa-download"></i> <?php echo DOWNLOAD_CSV; ?></a></p>
                                <div class="clearfix"></div>
                            <?php } ?>
                            <!-- DOWNLOAD PDF -->
                            <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                <p class="text-right mb-2"><a target="<?php echo $form_target;?>" href="<?php echo ADMIN_URL; ?>pages<?php echo PHP_EXTENSION; ?>/stream-pdf/" class="btn btn-dark"><i class="fa fa-download"></i> <?php echo DOWNLOAD_PDF; ?></a></p>
                                <div class="clearfix"></div>
                            <?php } ?>
