                    ...
                    <div class="col-11">
                        <div id="content-area">
                            ...
                            <?php echo suInfo(PASSWORD_AUTO_GENERATED); ?>
                                <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>users-remote<?php echo PHP_EXTENSION; ?>/add/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">
