                    ...
                    <div class="col-11">
                        <div id="content-area">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6 text-right"><a href="<?php echo ADMIN_URL; ?>header<?php echo PHP_EXTENSION; ?>/?overlay=<?php echo $_GET['overlay']; ?>"><i class="fa fa-table"></i></a></div>
                            </div>

                            <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>headers-remote<?php echo PHP_EXTENSION; ?>/sort/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="<?php echo $form_target;?>" >
                                <ul id="sortable">
