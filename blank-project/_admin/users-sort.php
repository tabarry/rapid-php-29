                ...
                <div class="row">
                    ...
                    <div class="col-11">
                        <div id="content-area">
                            ...
                            <form class="form-horizontal" action="<?php echo ADMIN_URL; ?>users-remote<?php echo PHP_EXTENSION; ?>/sort/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >
                                    <ul id="sortable">
